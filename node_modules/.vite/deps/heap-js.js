//#region node_modules/heap-js/dist/heap-js.es5.js
...
var HeapAsync = function() {
	...
	*/
	HeapAsync.prototype.add = function(element) {
		return __awaiter(this, void 0, void 0, function() {
			return __generator$1(this, function(_a) {
				switch (_a.label) {
					case 0: return [4, this._sortNodeUp(this.heapArray.push(element) - 1)];
					case 1:
						_a.sent();
						this._applyLimit();
						return [2, true];
	...
	*/
	HeapAsync.prototype.bottom = function() {
		return __awaiter(this, arguments, void 0, function(n) {
			if (n === void 0) n = 1;
			return __generator$1(this, function(_a) {
				if (this.heapArray.length === 0 || n <= 0) return [2, []];
				else if (this.heapArray.length === 1) return [2, [this.heapArray[0]]];
				else if (n >= this.heapArray.length) return [2, __spreadArray$1([], __read$1(this.heapArray), false)];
				else return [2, this._bottomN_push(~~n)];
			});
		});
	};
	/**
	...
	HeapAsync.prototype.init = function(array) {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator$1(this, function(_a) {
				switch (_a.label) {
					case 0:
						if (array) this.heapArray = __spreadArray$1([], __read$1(array), false);
	...
	HeapAsync.prototype.pop = function() {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator$1(this, function(_a) {
				...
				if (this.length > 0 && last !== void 0) return [2, this.replace(last)];
				return [2, last];
			});
		});
	};
	...
	*/
	HeapAsync.prototype.push = function() {
		...
		return __awaiter(this, void 0, void 0, function() {
			return __generator$1(this, function(_a) {
				if (elements.length < 1) return [2, false];
				else if (elements.length === 1) return [2, this.add(elements[0])];
				else return [2, this.addAll(elements)];
			});
		});
	};
	/**
	...
	*/
	HeapAsync.prototype.pushpop = function(element) {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator$1(this, function(_b) {
				switch (_b.label) {
					case 0: return [4, this.compare(this.heapArray[0], element)];
					case 1:
	...
	HeapAsync.prototype.remove = function(o_1) {
		return __awaiter(this, arguments, void 0, function(o, fn) {
			...
			return __generator$1(this, function(_a) {
				switch (_a.label) {
					case 0:
						if (!this.heapArray.length) return [2, false];
					...
					case 11:
						children = HeapAsync.getChildrenIndexOf(idx).filter(function(c) {
	...
	*/
	HeapAsync.prototype.top = function() {
		return __awaiter(this, arguments, void 0, function(n) {
			...
			return __generator$1(this, function(_a) {
				if (this.heapArray.length === 0 || n <= 0) return [2, []];
				else if (this.heapArray.length === 1 || n === 1) return [2, [this.heapArray[0]]];
				else if (n >= this.heapArray.length) return [2, __spreadArray$1([], __read$1(this.heapArray), false)];
				else return [2, this._topN_push(~~n)];
			});
		});
	};
	/**
			...
			return __generator$1(this, function(_a) {
				switch (_a.label) {
					...
					case 1:
						...
						indices = [];
						for (i = startAt; i > parentStartAt; --i) indices.push(i);
						arr = this.heapArray;
						_a.label = 2;
					case 2:
					...
					case 4:
						_a.sent();
						if (i % 2) indices.push(HeapAsync.getParentIndexOf(i));
						_a.label = 5;
					case 5: return [3, 2];
					case 6: return [2, bottomHeap.toArray()];
				}
			});
		});
	};
			...
			return __generator$1(this, function(_b) {
				switch (_b.label) {
					...
					case 4:
						...
						return [3, 1];
					case 5:
						if (i !== originalIndex) this.heapArray[i] = value;
						return [2];
				}
			});
		});
			...
			return __generator$1(this, function(_a) {
				switch (_a.label) {
					...
					case 2:
						...
						return [3, 6];
					case 3: return [4, this.compare(arr[i], topHeap.peek())];
					case 4:
					...
					case 5:
						...
						_a.label = 6;
					case 6: return [3, 1];
					case 7: return [2, topHeap.toArray()];
				}
			});
		});
	};
			...
			return __generator$1(this, function(_a) {
				switch (_a.label) {
					...
					case 1:
						...
						indices = [];
						for (i = branch; i < n; ++i) indices.push.apply(indices, __spreadArray$1([], __read$1(HeapAsync.getChildrenIndexOf(i).filter(function(l) {
					...
					case 4:
						...
						_a.label = 5;
					case 5: return [3, 2];
					case 6: return [2, topHeap.toArray()];
				}
			});
		});
	};
...
var Heap = function() {
	...
	*/
	Heap.prototype.bottom = function(n) {
		...
		else if (n >= this.heapArray.length) return __spreadArray([], __read(this.heapArray), false);
	...
	*/
	Heap.prototype.init = function(array) {
		if (array) this.heapArray = __spreadArray([], __read(array), false);
		for (var i = Heap.getParentIndexOf(this.length - 1); i >= 0; --i) this._sortNodeDown(i);
		this._applyLimit();
	};
	/**
	* Test if the heap has no elements.
	...
	*/
	Heap.prototype.indexOf = function(element, callbackFn) {
		...
		while (currentIndex < this.heapArray.length) {
			...
			else if (this.compare(currentElement, element) <= 0) indexes.push.apply(indexes, __spreadArray([], __read(Heap.getChildrenIndexOf(currentIndex)), false));
	...
	*/
	...
	Object.defineProperty(Heap.prototype, "limit", {
		...
		*/
		set: function(_l) {
			if (_l < 0 || isNaN(_l)) this._limit = 0;
			else this._limit = ~~_l;
			this._applyLimit();
		},
		enumerable: false,
	...
	*/
	Heap.prototype.pop = function() {
		...
		if (this.length > 0 && last !== void 0) return this.replace(last);
		return last;
	};
	/**
	* Pushes element(s) to the heap.
	...
	Heap.prototype.remove = function(o, callbackFn) {
		...
		while (queue.length) {
			...
			if (callbackFn(this.heapArray[idx], o)) {
				if (idx === 0) this.pop();
				else if (idx === this.heapArray.length - 1) this.heapArray.pop();
				else {
					this.heapArray.splice(idx, 1, this.heapArray.pop());
				...
				var children = Heap.getChildrenIndexOf(idx).filter(function(c) {
					return c < _this.heapArray.length;
				});
	...
	Heap.prototype._bottomN_push = function(n) {
		...
		while (indices.length) {
			...
			if (this.compare(arr[i], bottomHeap.peek()) > 0) {
				...
				if (i % 2) indices.push(Heap.getParentIndexOf(i));
			}
		}
	...
	*/
	Heap.prototype._topN_fill = function(n) {
		...
		var indices = [];
		for (var i = branch; i < n; ++i) indices.push.apply(indices, __spreadArray([], __read(Heap.getChildrenIndexOf(i).filter(function(l) {
			return l < heapArray.length;
		})), false));
		if ((n - 1) % 2) indices.push(n);
		while (indices.length) {
	...
	*/
	Heap.prototype._topIdxOf = function(list) {
		...
		var idx = 0;
		var top = list[idx];
		for (var i = 1; i < list.length; ++i) if (this.compare(list[i], top) < 0) {
			idx = i;
			top = list[i];
		}
		return idx;
...
//#endregion
export { Heap, Heap as default, HeapAsync, toInt };
